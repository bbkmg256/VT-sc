...
ruta principal de CODIGO para el proyecto django al dir. src (trabajando con esta esquematizacion de
directorios), ya que desde ahí tanto django (y en mi caso) como los LSP empezaran a buscar modulos y leer codigo
desde ese dir de codigo fuente digamos, (no desde el dir padre del proyecto, sino el dir padre donde se aloja todo el
